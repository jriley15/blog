...
const useStyles = makeStyles(theme => ({
  root: {
    background:
      "linear-gradient(rgba(13, 186, 134, 0.8), rgba(120, 80, 228, 0.8)), url('https://d2v9y0dukr6mq2.cloudfront.net/video/thumbnail/JrbItQz/white-polygonal-geometric-surface-seamless-loop-4k-uhd-3840x2160_nyllfzz7e__F0000.png') no-repeat center",
      ...
      >
        <g transform="">
          ...
          >
            ...
            <stop stopColor="#303030" stopOpacity="0.8" offset="25%"></stop>
            <stop stopColor="#303030" stopOpacity="0.5" offset="50%"></stop>
            <stop stopColor="#303030" stopOpacity="0.5" offset="75%"></stop>
            <stop stopColor="#303030" stopOpacity="0.3" offset="100%"></stop>
          </linearGradient>
          <path
